...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train/ori-best/weights/best.pt', help='model path(s)')
    parser.add_argument('--source', type=str, default='data/SAR-AIRcraft-1.0/JPEGImages/test', help='file/dir/URL/glob, 0 for webcam')
