...
Usage:
    $ python train.py --data coco.yaml --weights yolov3.pt --img 640
"""
import argparse
import math
import os
...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default=ROOT / 'pre-yolov3.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default=ROOT / 'models/resnet34.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'SARplane.yaml', help='dataset.yaml path')
