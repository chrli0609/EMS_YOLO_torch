...
if __name__ == '__main__':
    # classes = ['car','Van','person','Cyclist','Tram','Misc','DontCare','Truck','Person_sitting']
    classes = ["Boeing787", "Boeing737", "A220", "A330","other", "ARJ21", "A320/321"]
