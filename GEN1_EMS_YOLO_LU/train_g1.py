...
def parse_opt(known=False):
    ...
    print("parser pre arguments", parser.parse_known_args())

    parser.add_argument('--weights', type=str, default=ROOT / '', help='initial weights path')

    print("parser post weights", parser.parse_known_args())
    ...
    print("parser post img", parser.parse_known_args())
    ...
    print("parser post all", parser.parse_known_args())
